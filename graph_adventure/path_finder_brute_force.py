...
def path_finder_brute_force(world):
    ...
    while True:
        ...
        if cur_shortest == None or len(return_path) < len(cur_shortest):
            actual_return_path = []
            ...
            cur_shortest = actual_return_path.copy()
            print("\n******\nShortened Path\n******\n")
            print(cur_shortest)
            print("\n******\nShortened Path\n******\n")
            print(f"Length: {len(cur_shortest)}")
            f = open("shortest.txt", "w")
            f.write(f"{len(cur_shortest)}\n")
            f.write(f"{cur_shortest}")
            f.close()
        # Resetting stuff
        return_path = []
        visited = set()
...
def bfs_nearest_unexplored(source_room, main_visited):
    ...
    print(f"length of visited: {len(main_visited)}")

path_finder_brute_force(world)